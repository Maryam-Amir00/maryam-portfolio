...
const homeEntries = collect([
  entry(
    ...
    [personalInfo.role, personalInfo.specialization, personalInfo.focus, "home", ...personalInfo.stack],
  ),
  entry(
    "home-stack",
    FILE_HOME,
...
const aboutEntries = collect([
  entry(
    ...
    ["full-stack development", "react", "django", "authentication", "dashboards", "postgresql", "about"],
  ),
  entry(
    "about-build",
    FILE_ABOUT,
...
const experienceEntries = collect([
  ...
  entry(
    ...
    "Estimated 30% duplicate UI reduction",
    "Built a reusable React component library, reducing duplicated interface code by an estimated 30%.",
    ["30%", "~30%", "duplicate ui"],
  ),
  entry(
  ...
  entry(
    ...
    "Estimated 20% fewer unnecessary API re-fetches",
    "Optimized frontend data-fetching with TanStack Query, reducing unnecessary API re-fetches by an estimated 20%.",
...
const movixxxEntries = collect([
  ...
  entry(
    ...
    "API Integration",
    "OMDb API",
    "Integrated movie search data through the OMDb API.",
    ["omdb", "api"],
  ),
  entry(
    "movixxx-watchlist",
