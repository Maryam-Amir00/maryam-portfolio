...
export function SidebarPanel({
  ...
  return (
    <aside
      aria-label={label}
      tabIndex={-1}
      className="flex h-full w-full min-h-0 shrink-0 flex-col overflow-hidden border-r border-subtle bg-sidebar outline-none max-md:border max-md:border-subtle md:w-[min(20rem,calc(100vw-4rem))] lg:w-[248px]"
    >
      <div className="flex min-h-11 shrink-0 items-center px-3 lg:h-9 lg:min-h-9 lg:px-4">
        ...
        <button
          ...
          onClick={handleClose}
          className="ml-auto inline-flex size-11 items-center justify-center text-fg-muted ui-transition hover:bg-hover hover:text-fg lg:hidden"
        >
